...
* Log
** [2022-12-25 Sun 18:11] v0.0.4 (pypi)
Really added the py.typed this time
** [2022-12-25 Sun 18:01] v0.0.3 (pypi)
Trying the py.typed again
** [2022-12-25 Sun 17:55] Sent to pypi
** [2022-12-25 Sun 17:52] v0.0.2
Added py.typed file
** [2022-12-25 Sun] Uploaded to github and pypi
** [2022-12-25 Sun] v0.0.1
** [2022-12-25 Sun] Project creation
* [[https://pypi.org/project/orgee/][orgee · PyPI]]
* [[https://github.com/chunglak/orgee][GitHub - chunglak/orgee]]
* Configuration
:PROPERTIES:
...
*** PATH upload-to-pypi
:PROPERTIES:
:file-path: "/home/chunglak/projects/orgee/bin/upload-to-pypi"
:file-path-link: [[file:/home/chunglak/projects/orgee/bin/upload-to-pypi][upload-to-pypi]]
:END:
#+call: make-file-path()
#+begin_src bash :shebang #!/bin/bash
set -eu
...
*** PATH template.org
:PROPERTIES:
:file-path: "/home/chunglak/projects/orgee/org/template.org"
:file-path-link: [[file:/home/chunglak/projects/orgee/org/template.org][template.org]]
:END:
#+call: make-file-path()
